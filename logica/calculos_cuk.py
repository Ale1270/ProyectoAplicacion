...
def simular_sistema_cuk(Vin, L1, C1, L2, C2, R, D, f_sw, t_simulacion, callback_progreso=None):
    ...
    Ecuaciones de estado revisadas y corregidas para garantizar concordancia con el diseño ideal.
    """
    T = 1.0 / f_sw
    pasos_por_ciclo = 70
    ...
    for k in range(num_steps - 1):
        ...
        if es_estado_on:
            ...
            k3_1 = (Vin - y2_mid2) / L1
            k3_2 = y1_mid2 / C1
            k3_3 = -y4_mid2 / L2    # Corregido: -y4_mid2
            k3_4 = (y3_mid2 - y4_mid2 / R) / C2
            ...
            k4_1 = (Vin - y2_end) / L1
            k4_2 = y1_end / C1
            k4_3 = -y4_end / L2     # Corregido: -y4_end
            k4_4 = (y3_end - y4_end / R) / C2
